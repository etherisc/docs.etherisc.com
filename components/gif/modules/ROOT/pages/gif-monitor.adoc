...
==== Oracles
ou will find all oracles available on the platform in the '`Oracles dialogue.`' Here you can view all input and callback formats as a product owner. In addition, the appropriate oracle can be requested from the Oracle owners.
